...
export class AiService {
  ...
  async auditAudio(request: {
    ...
    // =====================================================
    // TWO-STEP APPROACH FOR ROBUST LONG AUDIO HANDLING
    ...
    // Step 2: Perform audit on the transcript
    ...
    return {
      ...
      identifiedAgentName: transcriptionResult.identifiedAgentName,
      rootCauseAnalysis: auditResult.callSummary, // Will be computed in audit
      timing: {
    ...
    this.logger.error(`Two-step audio audit failed: ${error.message}`);
