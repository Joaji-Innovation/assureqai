...
export default function NotificationsPage() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const mappedNotifications = Array.isArray(alerts)
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((notification) => (
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer transition-all hover:shadow-md ${getTypeBg(notification.type)} ${
